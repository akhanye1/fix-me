...
public class CheckSum {
    ...
    public static String checkSum(String message) {
        ...
        String checksum = SENDER_ID + separator + ORDER_TYPE + separator + MARKET_ID + separator + fixmecore.Encrypt.encrypt(ORDER_QUANTITY + separator + ORDER_PRICE + separator + ORDER_STATUS);
        return (checksum);
    }
}
